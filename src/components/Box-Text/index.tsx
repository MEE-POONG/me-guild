            ...
            <div className="outer-border bg-[#ffffff]">
                <div className="mid-border">
                    <div className="inner-border">
                        <img className="corner-decoration corner-left-top" src="/images/box-one.png" />
                        <img className="corner-decoration corner-right-top" src="/images/box-one.png" />
                        <img className="corner-decoration corner-right-bottom" src="/images/box-one.png" />
                        <img className="corner-decoration corner-left-bottom" src="/images/box-one.png" />
