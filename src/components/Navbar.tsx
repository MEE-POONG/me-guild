...
import NavClickDropdown from './NavClickDropdown';
                                ...
                                >
                                    ...
                                    >
                                        {item.list.map((listPage) => (
                                            <li>
                                                <Link key={listPage.label} href={listPage.href} className={`block text-white px-4 py-2 items-center space-x-2 transition hover:text-[#f2b265]`}>
                                                    {listPage.label}
                                                </Link>
                                            </li>
