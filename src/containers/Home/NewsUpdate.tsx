        ...
        <>
            <section className="text-gray-600 body-font">
                <div className="px-5 py-24 mx-auto">
                    <p className="text-2xl font-bold py-3">News</p>
                            ...
                            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                <img className="lg:h-48 md:h-36 w-full object-cover object-center" src="/images/bg01.png" alt="blog" />
                                    <div className="p-6">
                                        ...
                                        <p className="leading-relaxed mb-3 line-clamp-2">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
