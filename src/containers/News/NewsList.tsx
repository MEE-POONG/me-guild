                        ...
                        <div key={news.id} className="p-1 w-1/2 lg:w-1/3">
                            <div className="h-full drop-shadow-lg">
                                ...
                                <div className="p-3">
                                    ...
                                    <Link href={`/blog/news/${news.id}`} className="title-font text-sm md:text-lg font-medium mb-3 text-white hover:text-teal-500 leading-3">
                                        {news.title}
                                    </Link>
                                    <p className="text-xs line-clamp-3 font-extralight text-gray-400 mt-3">{news.description}</p>
                                    <div className="mt-5">
                                        <Link href={`/blog/news/${news.id}`} className="text-white inline-flex items-center md:mb-2 lg:mb-0 text-sm bg-gray-500/50 p-2 rounded hover:bg-red-600">
                                            Read
