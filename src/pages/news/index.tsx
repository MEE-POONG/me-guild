    ...
    return (
        <Layout>
            <div className="max-w-4xl container mx-auto px-4">
                <p className="text-xl font-bold flex items-end justify-between text-gray-500 hover:text-gray-800 border-b border-gray-400 pb-2">
                    <span>Game trends <span className="text-xs bg-blue-400 px-1 rounded-md text-white font-light">Update</span></span>
                    <a href="" className="text-sm">All {'>>'}</a>
                </p>
                <div className="flex flex-wrap mt-5">
                    {/* strt card */}
                    <div className="p-1 md:w-1/2 lg:w-1/4 ">
